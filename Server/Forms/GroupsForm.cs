...
namespace Server.Forms {
    ...
    public partial class GroupsForm : Form {
        // Конструктор:
        public GroupsForm() => InitializeComponent();
        // Событие при загрузке формы
        private void GroupsForm_Load(object sender, EventArgs e) => updateData();
        ...
        private void updateData(){
            ...
            // Первая колонка пользователю не нужна. Скрываем
            dataGridView1.Columns[0].Visible = false;
            // Заголовок для необходимого столбца
            dataGridView1.Columns[1].Name = "Группа";
            // кнопки активируются или деактивируются в зависимости от наличия групп
            editButton.Enabled = deleteButton.Enabled = dataGridView1.Rows.Count == 0 ? false : true; 
        }
